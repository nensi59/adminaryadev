          ...
          <div class="col-md-10	">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                <form action="{{route('insert_product.store')}}" method="post" enctype="multipart/form-data">
              @csrf
                  <div class="form-group">
                    <label for="exampleInputEmail1">Product Name</label>
                    <input type="text" class="form-control" id="exampleInputEmail1"  name="product_name" placeholder="Enter Product Name" required>
                  </div>
				   		   <div class="form-group">
                   <label for="customFile">Product Image</label>
                    ...
                    <div class="custom-file">
                      ...
                      <input type="file" class="custom-file-input"  name="product_image" id="customFile" required>
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1"  name="product_chamical" placeholder="Enter Product Chamical" required>
                  </div>
				  <div class="form-group">
                    <label for="exampleInputEmail1">Product Packing</label>
                    <input type="text" class="form-control" id="exampleInputEmail1"  name="product_packing" placeholder="Enter Product Packing" required>
                  </div>
				  ...
				  <div class="form-group">
                        ...
                        <select class="form-control"  name="catagory_name">
                          ...
                          <option value="Harbiside">Harbicide</option> 
