                    ...
                    <div class="right-product-box">
                        ...
                        <div class="product-categorie-box">
                            <div class="tab-content">
                                ...
                                <h1  class="display-4" align="center"><b>Seed Treatment</b></h1>
                                    <div class="row pt-3">
                                    @foreach($products as $product)	
                                    <div class="col-md-6 col-lg-4 col-xl-4">
												<div class="blog-box">
													<div class="blog-img ">
														<img class="img-fluid"  height="200px" width="200px" src="{{asset('uploads/'. $product->product_image)}}" alt="" />
													</div>
													<div class="shop-cat-box">
														<div class="title-blog">
															<h3 align="center">{{$product->product_name }}</h3><br>
															<a class="btn hvr-hover" href="{{route('seed_treatment.show',$product->product_name)}}">Know More</a>
															<p></p>
														</div>
